        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-purple-700 mb-6">
              The Prismatic version of Sushi is an exquisite delicacy sought
              after by culinary virtuosos. This legendary dish requires rare
              ingredients and precise timing, offering exceptional rewards and
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="bg-white/80 backdrop-blur rounded-lg p-5 border border-purple-100">
                ...
                <ul className="space-y-2 text-purple-700">
                  ...
                  <li className="flex items-center">
                    <span className="text-purple-500 mr-2">•</span>
                    Must be prepared during Ocean Festival (seasonal in-game
                    event)
                  </li>
                  <li className="flex items-center">
                    <span className="text-purple-500 mr-2">•</span>
                    Requires the &quot;Sushi Master&quot; badge (complete 40
                    perfect seafood recipes)
                  </li>
                </ul>
              </div>
