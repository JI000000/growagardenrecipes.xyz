...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'grow a garden waffle',
    'waffle ingredients grow a garden',
    'waffle cooking time grow a garden',
...
export default function WaffleRecipePage() {
  const waffleRecipe = detailedRecipes.waffle;

  // Get related recipes data
  const relatedRecipes = waffleRecipe.relatedRecipes
  ...
  return (
    <>
      ...
      <section id="ingredients" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {waffleRecipe.ingredients.map((ingredient, index) => (
              <div
                key={index}
                className="bg-yellow-50 rounded-xl p-6 border border-yellow-100 shadow-md"
              >
          ...
          <div className="bg-yellow-50 rounded-xl p-6 border border-yellow-100 shadow-md max-w-3xl mx-auto">
            ...
            <ul className="space-y-3 text-yellow-700">
              ...
              <li className="flex items-start">
                <span className="text-yellow-500 mr-2">•</span>
                The 2025 update added special toppings that can be unlocked
                through quests
              </li>
            </ul>
          </div>
      ...
      <section
        id="steps"
        className="py-16 bg-gradient-to-br from-yellow-50 to-amber-50"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-display font-bold text-yellow-900 mb-4">
            ...
            <p className="text-lg text-yellow-700 max-w-3xl mx-auto">
              Follow these precise steps to cook the perfect waffle in Grow a
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              <div
                className="absolute left-9 top-0 h-full w-0.5 bg-yellow-200"
                aria-hidden="true"
              ></div>

              <div className="space-y-12">
                {waffleRecipe.steps.map((step, index) => (
                  <div key={index} className="relative">
                    <div className="flex items-center">
                      <div className="absolute left-0 rounded-full h-18 w-18 flex items-center justify-center bg-yellow-100 border-4 border-yellow-200 z-10">
                      ...
                      <div className="pl-24">
                        <div className="bg-white rounded-xl p-6 shadow-md">
                          ...
                          <p className="text-yellow-700">{step.tip}</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="max-w-3xl mx-auto mt-16 bg-white rounded-xl p-6 border border-yellow-200 shadow-md">
            <div className="flex items-center mb-4">
            ...
            <p className="text-yellow-700 mb-4">
              The perfect cooking time for waffles is exactly 5 minutes and 30
            ...
            <ul className="space-y-2 text-yellow-800">
              <li className="flex items-start">
                <span className="text-yellow-500 mr-2">•</span>
                <strong>0:00-1:15:</strong> The batter should be smooth with no
                lumps
              </li>
              <li className="flex items-start">
                <span className="text-yellow-500 mr-2">•</span>
                <strong>1:15-2:30:</strong> The butter should be fully
                incorporated
              </li>
              <li className="flex items-start">
                <span className="text-yellow-500 mr-2">•</span>
                <strong>2:30-3:15:</strong> The waffle iron should be properly
                preheated
              </li>
              <li className="flex items-start">
                <span className="text-yellow-500 mr-2">•</span>
                <strong>3:15-4:45:</strong> The waffle should rise and start to
                turn golden
              </li>
              <li className="flex items-start">
                <span className="text-yellow-500 mr-2">•</span>
                <strong>4:45-5:30:</strong> The waffle should be golden brown
                and crispy
              </li>
            </ul>
          </div>
      ...
      <section id="rewards" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-yellow-700 max-w-3xl mx-auto">
              Learn about the rewards for perfect waffles and advanced tips to
              maximize your benefits.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            <div className="bg-yellow-50 rounded-xl p-6 border border-yellow-100 shadow-md">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-lg p-4 border border-yellow-100">
                  ...
                  <p className="text-yellow-700">
                    {waffleRecipe.rewards.prismatic}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 rounded-xl p-6 border border-yellow-100 shadow-md">
              ...
              <ul className="space-y-3">
                {waffleRecipe.tips.map((tip, index) => (
                  <li
                    key={index}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {waffleRecipe.variations.map((variation, index) => (
                <div
                  key={index}
                  className="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-xl p-6 border border-yellow-100 shadow-md hover:shadow-lg transition-shadow"
                >
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold text-purple-900 flex items-center">
                <span className="text-3xl mr-3">🌈</span> Prismatic Waffle
              </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="bg-white/80 backdrop-blur rounded-lg p-5 border border-purple-100">
                ...
                <ul className="space-y-2 text-purple-700">
                  ...
                  <li className="flex items-center">
                    <span className="text-purple-500 mr-2">•</span>
                    Perfect timing (exactly 5 minutes 30 seconds)
                  </li>
                  <li className="flex items-center">
                    <span className="text-purple-500 mr-2">•</span>
                    Must be prepared during Breakfast Festival events
                  </li>
                  <li className="flex items-center">
                    <span className="text-purple-500 mr-2">•</span>
              ...
              <div className="bg-white/80 backdrop-blur rounded-lg p-5 border border-purple-100">
                ...
                <ul className="space-y-2 text-purple-700">
                  ...
                  <li className="flex items-center">
                    <span className="text-purple-500 mr-2">•</span>
                    Guaranteed Rare Breakfast Item
                  </li>
                  <li className="flex items-center">
                    <span className="text-purple-500 mr-2">•</span>
      ...
      <section className="py-16 bg-gradient-to-br from-yellow-50 to-amber-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              (recipe, index) =>
                recipe && (
                  <Link
                    ...
                    className="bg-white rounded-xl p-6 border border-yellow-100 shadow-md hover:shadow-lg transition-shadow hover:-translate-y-1 transform transition-transform"
                  >
                    <div className="flex items-center mb-4">
                    ...
                    <p className="text-yellow-700">{recipe.description}</p>
                  </Link>
                )
            )}
          </div>
          ...
          <div className="text-center mt-12">
            <Link
              href="/recipes"
              className="inline-block px-8 py-4 bg-yellow-600 hover:bg-yellow-700 text-white rounded-xl font-medium transition-colors shadow-md hover:shadow-lg"
            >
              Browse All Recipes
            </Link>
          </div>
